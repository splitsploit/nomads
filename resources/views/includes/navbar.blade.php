    ...
    <div class="container">
        <nav class="row navbar navbar-expand-lg navbar-light bg-white">
            <a href="{{ url ('/') }}" class="navbar-brand">
                <img src="frontend/images/logo.png" alt="logo travest">
            </a>
        ...
        <div class="collapse navbar-collapse" id="navb">
            ...
            <ul class="navbar-nav ml-auto mr-3">
             ...
             @guest
                   ...
                   <!-- Mobile Button -->
                   <form class="inline d-sm-block d-md-none">
            ...
            <!-- Desktop Button -->
            <form class="inline my-2 my-lg-0 d-none d-md-block">
            ...
            @auth
              <!-- Mobile Button -->
              <form class="inline d-sm-block d-md-none" action="{{ url ('logout') }}" method="POST">
                @csrf
        ...
        <!-- Desktop Button -->
        <form class="inline my-2 my-lg-0 d-none d-md-block" action="{{ url ('logout') }}" method="POST">
            @csrf
